...
# Read po, receipt ----
po <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 01.04.23.xlsx",
                 sheet = "po",
                 col_names = FALSE)


receipt <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 01.04.23.xlsx",
                      sheet = "receipt",
                      col_names = FALSE)
...
openxlsx::saveWorkbook(example, file = "po, receipt 0105.xlsx")
